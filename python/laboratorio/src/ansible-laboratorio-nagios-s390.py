...
def ajuda():
    print('''
    Ajuda ansible-laboratorio-nagios-s390.py

    Sintaxe: ./ansible-laboratorio-nagios-s390.py <Servidor> <IP> [Descricao]
    ...
    Exemplo:
        ...
        ./ansible-laboratorio-nagios-s390.py jbsp999 "127.0.0.9" "Servidor JBoss de teste"
