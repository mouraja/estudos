...
def ajuda():
    print('''
    Ajuda ansible-laboratorio-nagios-csv-delete.py

    Sintaxe: ./ansible-laboratorio-nagios-csv-delete.py <Arquivo-CSV>
    ...
    Exemplo:
        ...
        ./ansible-laboratorio-nagios-csv-delete.py meusservidores.csv
...
host = ServidorCsv(nagl101.nagios, nagl101.api)
