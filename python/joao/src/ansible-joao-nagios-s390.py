...
def ajuda():
    print('''
    Ajuda ansible-joao-nagios-s390.py

    Sintaxe: ./ansible-joao-nagios-s390.py <Servidor> <IP> [Descricao]
    ...
    Exemplo:
        ...
        ./ansible-joao-nagios-s390.py jbsp999 "127.0.0.9" "Servidor JBoss de teste"
